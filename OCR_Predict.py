...
def process_line(line, line_order,dilated2,img,all_predictions_with_order):
    try:
        ...
        pass  # Ignore errors from subprocess.CalledProcessError and continue to the next iteration
...
def Predict(image_filePath):
    ...
    with ThreadPoolExecutor() as executor:
        for i, line in enumerate(sorted_contours_lines):
            executor.submit(process_line, line, i,dilated2,img,all_predictions_with_order)
